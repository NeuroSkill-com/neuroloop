...
3. [EXG Frequency Bands](#3-eeg-frequency-bands)
4. [EXG Indices](#4-eeg-indices)
...
12. [EXG Embedding Models & HNSW Search](#12-eeg-embedding-models--hnsw-search)
...
> Monastra, V. J., Lubar, J. F., Linden, M. et al. (1999). Assessing attention deficit hyperactivity disorder via quantitative electroencephalography. *Neuropsychology*, 13(3), 424–433. [doi:10.1037/0894-4105.13.3.424](https://doi.org/10.1037/0894-4105.13.3.424)
...
*All 74 references verified via CrossRef API (api.crossref.org) and doi.org — February 2026.*
